...
$configurator->filename="ProjectDocument.swift";
$configurator->useActionsContainingString=array("Episode","User","Group","Permission","Operation","Project","Fragment","Note","Trigger");
