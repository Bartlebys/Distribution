...
class MetaFlexer {
    ...
    public function generateApp($generationFolderPath, $deletePreviousFiles = true, $stage) {
         ...
         * 1.1 - Merge:  merges the app and definitions descriptors in a global derivated descriptor.
        ...
        $globalDescriptorPath = $this->appFolderPath . '/descriptors/_derivated/_global.json';
