...
@objc(<?php echo$baseClassName ?>) public class <?php echo$baseClassName ?> : <?php echo GenerativeHelperForSwift::getBaseClass($f,$d); ?>,JHTTPCommand{
    ...
    required public convenience init(){
        self.init(<?php echo$firstParameterTypeString ?>(), <?php echo$dataSpaceSyntagm ?>:Default.NO_UID,observableBy:Default.NOT_OBSERVABLE)
    }
<?php
...
$_operation_rep->customSerializationMapping=array($_status_operation_rep,$_counter_operation_rep,$_creationDate_operation_rep,$_baseUrl_operation_rep);
$virtualEntity->properties[]=$_operation_rep;

$_observationUID_rep=new PropertyRepresentation();
$_observationUID_rep->name="_observationUID";
$_observationUID_rep->type=FlexionsTypes::STRING;
$_observationUID_rep->required=true;
$_observationUID_rep->isDynamic=false;
$_observationUID_rep->default="Default.NOT_OBSERVABLE";
$_observationUID_rep->isGeneratedType=false;
$virtualEntity->properties[]=$_observationUID_rep;
...
?>
    ...
    */
    init (_ <?php echo$firstParameterName ?>:<?php echo$firstParameterTypeString ?>=<?php echo$firstParameterTypeString."()" ?>, <?php echo$dataSpaceSyntagm ?> spaceUID:String,observableBy observationUID:String=Default.NOT_OBSERVABLE) {
    ...
    */
    static func commit(<?php echo$firstParameterName ?>:<?php echo$firstParameterTypeString ?>, <?php echo$dataSpaceSyntagm ?> spaceUID:String,observableBy observationUID:String){
        let operationInstance=<?php echo$baseClassName ?>(<?php echo$firstParameterName ?>,<?php echo$dataSpaceSyntagm ?>:spaceUID,observableBy:observationUID)
